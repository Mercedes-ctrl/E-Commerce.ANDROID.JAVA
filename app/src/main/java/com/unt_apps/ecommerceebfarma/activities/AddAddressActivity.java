        ...
        addAddressBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (!userName.isEmpty() && !userCity.isEmpty() && !userAddress.isEmpty()&& !userNumber.isEmpty()){
                    ...
                    firestore.collection("CurrentUser").document(auth.getCurrentUser().getUid())
                        ...
                        public void onComplete(@NonNull Task<DocumentReference> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(AddAddressActivity.this, "Dirección añadida", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddAddressActivity.this, "LLene todos los campos", Toast.LENGTH_SHORT).show();
                }
